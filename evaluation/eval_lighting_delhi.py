...
QUERY = (
    "For this New_delhi small office buidling 2022 , reduce the lighting power density by 10 percent for all zones and compare it with basecase."
)
...
EXPECTED_TOOL_SEQUENCE = [
    ...
    "modify_lights",             # Increase occupancy
